...
Just open a pull request in the repo. All contributions will be accepted under the same terms as the license.
...
This means if you wish to modifiy and distribute retain, you must share the source code to the public and maintain the same freedoms GPLv3 provides.  
